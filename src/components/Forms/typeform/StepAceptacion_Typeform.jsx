...
import PreguntaAceptacionTerminos from './PreguntaAceptacionTerminos';

const StepAceptacion_Typeform = ({ onComplete, onProgressUpdate }) => {
  ...
  return (
    <div className="relative w-full h-auto min-h-[350px] flex items-center justify-center overflow-hidden">
      <AnimatePresence initial={false} custom={direction} mode="wait">
        ...
        >
          {currentQuestion === 1 && (
            <PreguntaAceptacionTerminos onComplete={handleQuestionComplete} />
          )}
        </motion.div>
      </AnimatePresence>
    </div>
...
export default StepAceptacion_Typeform;