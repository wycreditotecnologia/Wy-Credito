...
import SolicitudLayout from "./SolicitudLayout";
...
export default function MasterStepForm({
    ...
    return (
        <SolicitudLayout currentStep={currentStep} totalSteps={totalSteps}>
            <div className="w-full max-w-2xl">
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl p-8 sm:p-10 lg:p-12 border border-slate-100 dark:border-slate-800">
